...
const tokenToDecimals = (amount: number, token: string): number => {
  // This is a placeholder.  In a real application, you would
  // need to fetch the number of decimals for each token from
  // a reliable source (e.g., a smart contract or a configuration file).
  if (token === Tokens.WLD) {
    return amount * 10 ** 8 // Assuming WLD has 8 decimals
  } else if (token === Tokens.USDCE) {
    return amount * 10 ** 6 // Assuming USDCE has 6 decimals
  }
